...
export const DialogueElementItem:React.FC<{dialogueElement:DialogueElement, dialogueIndex: number, isResponding:boolean}> = ({dialogueElement, dialogueIndex, isResponding}) => {
  return (
    <div
                key={dialogueIndex}
                style={{
