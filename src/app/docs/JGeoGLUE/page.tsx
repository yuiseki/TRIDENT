          ...
          <div className="container is-max-desktop content">
            ...
            <div className="content has-text-justified">
              ...
              <p>
                ...
                たとえば、「東京都港区芝公園4-2-8
                東京タワー」という住所表記において、「芝公園」は町名、「東京タワー」は施設名として分類される。
              ...
              <p>
                ...
                例えば、「新宿駅から渋谷駅までの最短ルートを教えて」というクエリは、経路検索として分類され、
                「大阪城の入場料は？」というクエリは施設情報検索に該当する。
              ...
              <p>
                ...
                たとえば、「渋谷駅の北側」という表現は方向表現、
                「徒歩10分以内」という表現は距離・位置表現、
                「渋谷駅周辺」という表現は領域表現、
                「台東区は港区より広い」という比較表現は面積表現として分類される。
