  ...
  return (
    <>
      <title>
        ...
        {/* 英語 */}
        Morocco: Earthquake - Sep 2023 - TRIDENT Agent (Sep 18 version)
      </title>
      <article className="tridentAgentArticle">
        ...
        <section className="tridentAgentSection tridentAgentSectionFirst">
          ...
          */}
          <h2>Morocco: Earthquake - Sep 2023</h2>
        ...
        <section className="tridentAgentSection">
          ...
          <div className="tridentAgentSectionMain">
            <ul>
              ...
              */}
              <li>
                At 22:11 UTC on Sep 8, 2023, a strong earthquake of magnitude
                6.8 occurred in Morocco.
              </li>
              {/*
              // 日本語
              <li>
              ...
              */}
              <li>
                According to the information from the national authorities on
                Sep 8, 2946 people were killed and 5674 people were injured.
              </li>
              {/*
              // 日本語
              <li>
              ...
              */}
              <li>
                The Government of Morocco is implementing emergency response,
                and the United Nations is continuing close communication with
          ...
          <div className="tridentAgentSectionMain">
            <ul>
              ...
              */}
              {/* 英語 */}
              <li>
                Political system: Morocco is a constitutional monarchy, with the
                king as head of state and a parliamentary democracy.
              </li>
              <li>
                Major languages: Arabic and Berber are official languages, and
                French is widely used.
              </li>
              <li>Population: About 36.9 million (2021 estimate)</li>
              <li>
                Major Currencies: Moroccan Dirham (MAD)
              </li>
              <li>
                Economy: According to the World Bank, GDP in 2020 was about
                $124 billion.
              </li>
              <li>
                Major industries: Agriculture, tourism, manufacturing, and
                mining are the main industrial sectors. In particular, tourism
                to resorts is an important part of the economy.
              </li>
              <li>
                Healthcare: Morocco offers medical facilities at home and
                abroad, and general medical services are available, but there
                are regional differences in quality and access.
              </li>
              <li>
                Education: The education system is well developed and basic
                education is provided, but there are regional differences. French
                is important as part of the education.
              </li>
            </ul>
          </div>
          <span className="scrollDown scrollDownLeft"></span>
        ...
        <section className="tridentAgentSection">
          ...
          <div className="tridentAgentSectionDescription">
            ...
            */}
            {/* 英語 */}
            <h4>
              Morocco is a country in North Africa, facing the Mediterranean
              Sea and located at the northernmost tip of the African continent.
            </h4>
          </div>
          <span className="scrollDown scrollDownLeft"></span>
          <span className="scrollDown scrollDownRight"></span>
        ...
        <section className="tridentAgentSection">
          ...
          <div className="tridentAgentSectionDescription">
            ...
            */}
            {/* 英語 */}
            <h4>
              Morocco has diverse topography, including mountains, deserts,
              plains, and coastlines. The most famous topography is the Atlas
              Mountains.
            </h4>
            <h4>
              Morocco has a diverse climate, including Mediterranean climate,
              desert climate, and mountain climate.
            </h4>
          </div>
          <span className="scrollDown scrollDownLeft"></span>
          <span className="scrollDown scrollDownRight"></span>
        ...
        <section className="tridentAgentSection">
          <div className="tridentAgentSectionTitle">
            ...
            */}
            {/* 英語 */}
            <h3>
              Morocco Earthquake: Main affected areas
            </h3>
          </div>
          <div className="tridentAgentSectionMain">
            <StaticRegionsMap
          ...
          <div className="tridentAgentSectionDescription">
            ...
            */}
            {/* 英語 */}
            <h4>
              The center of the damage is in Al Haouz Province and Taroudant
              Province.
            </h4>
          </div>
          <span className="scrollDown scrollDownLeft"></span>
        ...
        <section className="tridentAgentSection">
          <div className="tridentAgentSectionTitle">
            ...
            */}
            {/* 英語 */}
            <h3>
              Morocco Earthquake: Building damage details
            </h3>
          </div>
          <div className="tridentAgentSectionMain">
            <StaticRegionsMap
            ...
            <div className="tridentAgentSectionDescription">
              ...
              */}
              {/* 英語 */}
              <h4>
                The details of the earthquake damage will be updated in the
                future.
              </h4>
            </div>
          </div>
          ...
          */}
          ...
          <h4>
            ...
            >
              ...
              */}
              {/* 英語 */}
              You can support disaster response through OpenStreetMap
            </a>
          </h4>
          <h4>
            <a
